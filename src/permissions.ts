...
export const ROLE_PERMISSIONS: Record<AppRole, RolePermissions> = {
  ...
  Technical: {
    ...
    canExport: false,
    canToggleFavorite: true,
    visibleFields: ['ctn_to_remarks_technical', 'salary_amount', 'technical_share', 'screenshot'],
    editableFields: ['ctn_to_remarks_technical', 'salary_amount', 'screenshot'], // technical_share is view-only
    canAccessAdmin: false,
  },
